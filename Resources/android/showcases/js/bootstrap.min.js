...
+function(a) {
        ...
        if (/(38|40|27)/.test(b.keyCode)) {
            ...
            if (b.preventDefault(), b.stopPropagation(), !d.is(".disabled, :disabled")) {
                ...
                if (h.length) {
                    ...
                    38 == b.keyCode && i > 0 && i--, 40 == b.keyCode && h.length - 1 > i && i++, ~i || (i = 0), 
                    h.eq(i).focus();
                }
            }
        }
    ...
    b.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (f) {
                ...
                d = "bottom" == d && g.top + g.height + i - l > n ? "top" : "top" == d && 0 > g.top - l - i ? "bottom" : "right" == d && g.right + h > m ? "left" : "left" == d && o > g.left - h ? "right" : d, 
        ...
        if ("top" == b && j != f && (c = !0, a.top = a.top + f - j), /bottom|top/.test(b)) {
            var k = 0;
            0 > a.left && (k = -2 * a.left, a.left = 0, d.offset(a), i = d[0].offsetWidth, j = d[0].offsetHeight), 
    ...
    b.DEFAULTS = {
        ...
        for (a = e.length; a--; ) g != f[a] && b >= e[a] && (!e[a + 1] || e[a + 1] >= b) && this.activate(f[a]);
