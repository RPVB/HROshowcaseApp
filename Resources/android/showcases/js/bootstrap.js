...
+function($) {
    ...
    Button.prototype.toggle = function() {
        ...
        if ($parent.length) {
            ...
            "radio" === $input.prop("type") && ($input.prop("checked") && this.$element.hasClass("active") ? changed = false : $parent.find(".active").removeClass("active"));
...
+function($) {
    ...
    Carousel.prototype.to = function(pos) {
        ...
        if (pos > this.$items.length - 1 || 0 > pos) return;
    ...
    $(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", function(e) {
        ...
        (slideIndex = $this.attr("data-slide-to")) && $target.data("bs.carousel").to(slideIndex);
        e.preventDefault();
    });
...
+function($) {
    ...
    Dropdown.prototype.keydown = function(e) {
        ...
        if (!isActive || isActive && 27 == e.keyCode) {
            27 == e.which && $parent.find(toggle).focus();
            return $this.click();
        }
    ...
    Tooltip.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (autoPlace) {
                ...
                placement = "bottom" == placement && pos.top + pos.height + actualHeight - docScroll > parentHeight ? "top" : "top" == placement && 0 > pos.top - docScroll - actualHeight ? "bottom" : "right" == placement && pos.right + actualWidth > parentWidth ? "left" : "left" == placement && parentLeft > pos.left - actualWidth ? "right" : placement;
...
+function($) {
    ...
    Affix.prototype.checkPosition = function() {
        ...
        var affix = null != this.unpin && scrollTop + this.unpin <= position.top ? false : null != offsetBottom && position.top + this.$element.height() >= scrollHeight - offsetBottom ? "bottom" : null != offsetTop && offsetTop >= scrollTop ? "top" : false;
